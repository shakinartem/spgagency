  ...
  return (
    <section id="process" className="section-shell px-4">
      <div className="mx-auto max-w-7xl">
        <SectionHeading
          eyebrow="Процесс"
          title="Спокойный стратегический процесс без маркетингового шума."
          description="Сначала разбираем коммерческую механику стоматологии, затем собираем систему каналов и усиливаем только то, что двигает пациента к записи."
        />
          ...
          {items.map((item, index) => (
            ...
            >
              ...
              <div>
                ...
                <h3 className="mt-2 font-display text-3xl uppercase text-paper">{item.title}</h3>
                <p className="mt-3 text-base leading-7 text-sand/75">{item.text}</p>
              </div>
            </motion.div>
          ))}
        </div>
