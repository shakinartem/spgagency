...
import { CaseDetailPageApp } from "./CaseDetailPageApp";
...
const caseId = root.dataset.caseId ?? window.location.pathname.split("/").pop()?.replace(".html", "") ?? "kerala";
...
ReactDOM.createRoot(root).render(
  <React.StrictMode>
    <CaseDetailPageApp basePath={basePath} caseId={caseId} />
  </React.StrictMode>,
);
