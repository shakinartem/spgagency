          ...
          <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[0.86fr_1.14fr] lg:items-start">
            <div className="max-w-2xl">
              ...
              <p className="mt-5 max-w-xl text-base leading-7 text-sand/80 sm:text-lg">
                Здесь собран многостраничный слой сайта: посадочные по нишам и услугам, а также практические материалы по вопросам,
                с которых бизнес обычно начинает поиск подрядчика.
              </p>
